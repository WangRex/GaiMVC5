...
namespace Apps.Web.Areas.Flow.Controllers
{
    public class FlowTrackController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Flow_FormContent> list = formContentBLL.GeExaminetList(ref setNoPagerAscById, "");
        ...
        {
            List<Flow_FormContent> list = formContentBLL.m_Rep.FindPageList(ref pager, queryStr).ToList();
            var json = new
            {
