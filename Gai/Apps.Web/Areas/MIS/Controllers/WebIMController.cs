...
namespace Apps.Web.Areas.Mis.Controllers
{
    public class WebIMController : BaseController
    {
        ...
        public MIS_WebIM_RecentContactBLL recentContactBLL = new MIS_WebIM_RecentContactBLL();



        public MIS_WebIM_CommonTalkBLL commonTalkBLL = new MIS_WebIM_CommonTalkBLL();
        ...
        public JsonResult GetCommonTalk()
        {
            ...
            List<MIS_WebIM_CommonTalk> list = commonTalkBLL.m_Rep.FindPageList(ref pager, "").ToList();
            StringBuilder sb = new StringBuilder();
            foreach (MIS_WebIM_CommonTalk m in list)
            {
        ...
        public JsonResult SendMessage(string mes, string receiver, string receiverName, bool state)
        {
            ...
            MIS_WebIM_Message model = new MIS_WebIM_Message()
            {
                ...
                SendDt = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")
        };
        ...
        public JsonResult GetRecentContact()
        {
            ...
            List<MIS_WebIM_RecentContact> list = recentContactBLL.GetList(ref gridModel, GetUserId());
            sb.Append("<ul id=\"RecentContactUL\">");
            foreach (MIS_WebIM_RecentContact model in list)
            {
        ...
        {
            List<SysUser> list = sysUserBLL.m_Rep.FindList(a => a.TrueName  == whereStr).ToList();
            if (list.Count > 0)
            {
                StringBuilder sb = new StringBuilder();
