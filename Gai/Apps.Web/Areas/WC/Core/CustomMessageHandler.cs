...
namespace Apps.Web.Areas.WC.Core
{
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
       ...
       : base(inputStream, postModel)
        ...
        //    WC_MessageResponseBLL message_BLL = new WC_MessageResponseBLL()
        //    {
        ...
        //    {
        //        //文本方式
        //        if (messageList[0].MessageRule == WeChatRequestRuleEnum.Text.ToString())
        //        {
        //            var responseMessage = base.CreateResponseMessage<ResponseMessageText>();
        ...
        //        }
        //        //图文方式
        //        else if (messageList[0].MessageRule == WeChatRequestRuleEnum.Image.ToString())
        //        {
        ...
        //            return responseMessage;
        //        }//一般很少用到
        //        else if (messageList[0].MessageRule == WeChatRequestRuleEnum.Voice.ToString())
        //        {
        ...
        //            return responseMessage;
        //        }//默认回复
        //        else if(messageList[0].MessageRule == WeChatRequestRuleEnum.Default.ToString())
        //        {
