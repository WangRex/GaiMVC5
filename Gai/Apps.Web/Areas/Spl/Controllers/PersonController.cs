...
namespace Apps.Web.Areas.Spl.Controllers
{
    ...
    {
        public Spl_PersonBLL m_BLL = new Spl_PersonBLL();
        ...
        {
            var personList = new List<Spl_Person>();
        ...
        {
            List<Spl_Person> list = m_BLL.m_Rep.FindPageList(ref setNoPagerAscById, "").ToList();
