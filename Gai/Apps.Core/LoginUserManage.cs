...
namespace Apps.Core
{
    public static class LoginUserManage
    {
        ...
        public static void Add(String sessID, String userId)
        {
            ...
            loginUsers.Set(userId.ToString(), sessID);
        ...
        public static bool ValidateRelogin(Account account)
        {
            bool bResult = false;
            if (account != null)
            {
        ...
        public static bool ValidateIsLogined(Account account)
        {
